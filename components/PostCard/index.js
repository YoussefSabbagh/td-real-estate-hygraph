...
const PostCard = ({ post }) => (
  <div className="mb-8 rounded-lg bg-white p-0 pb-12 shadow-lg lg:p-4">
    ...
    <h1 className="mb-8 cursor-pointer text-center text-xl font-semibold transition duration-700">
      <Link href={`/post/${post.slug}`} passHref>
        <span className="text-pink-600 hover:text-blue-400">{post.title}</span>
      </Link>
    </h1>
    ...
    <p className="mb-8 px-4 text-gray-700 summary">{post.excerpt}</p>
