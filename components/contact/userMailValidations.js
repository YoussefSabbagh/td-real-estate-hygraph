...
export const schema = Yup.object().shape({
  user_name: Yup.string().required('Debe ingresar su nombre'),
  subject: Yup.string().required('Por favor indique el asunto'),
  email: Yup.string().email().required('Debe ingresar su correo eléctronico'),
  message: Yup.string().required('Cuéntenos sobre qué nos quiere hablar'),
});
